...
<img src="http://www.nature.com/polopoly_fs/7.36719.1464174488!/image/reproducibility-graphic-online4.jpg_gen/derivatives/landscape_630/reproducibility-graphic-online4.jpg" height=450px>
</a>
...
- Integration with `git` version control and [GitHub](http://github.com)
...
- But my SPSS syntax file already does this
    - Great! How are you sharing them?
...
```{r, echo=FALSE, fig.align='center', out.width='100%'}
knitr::include_graphics("https://cdn.shopify.com/s/files/1/1657/2343/products/product-image-114090915_grande.jpg?v=1517721814")
```
...
- [Talks](https://raw.githubusercontent.com/gilmore-lab/DEVSEC-2018/master/promise-of-open-dev-sci/index.Rmd)
- [Project notes](https://github.com/gilmore-lab/infant-moco-eeg/blob/master/plan-of-work.Rmd)
- [Documentation]. [Rmd](https://raw.githubusercontent.com/gilmore-lab/databrary-reqmts-specs/master/databrary_1.0.Rmd) | [HTML](https://gilmore-lab.github.io/databrary-reqmts-specs/databrary_1.0.html)

## Ways to use R Markdown

- Figures. [Rmd](https://raw.githubusercontent.com/PLAY-behaviorome/site-demographics/master/educational_attainment.Rmd) | [PDF](https://github.com/PLAY-behaviorome/site-demographics/blob/master/img/ed-attain-bars-plot-1.pdf)
- Scriptable timelines from Datavyu files. [Rmd](https://github.com/PLAY-behaviorome/video-coding/blob/master/video-code-file-export-cleaning.Rmd) | [Example](https://github.com/PLAY-behaviorome/video-coding/blob/master/NYU020-timeline.md)
- Papers. [Rmd](https://raw.githubusercontent.com/psu-psychology/r-bootcamp-2018/master/talks/gilmore-hallquist-bootcamp-2018-papaja.Rmd) | [PDF](https://github.com/psu-psychology/r-bootcamp-2018/blob/master/talks/gilmore-hallquist-bootcamp-2018-papaja.pdf)
...
```{r}
lego_vol <- 563
list_volume_metadata(lego_vol)
```

---

```{r}
summarize_volume(lego_vol)
```
...
play_pilot_vol <- 444
session_id <- 18825
list_assets_in_session(session.id = session_id, vol.id = play_pilot_vol)
```
...
[Rendered Report in HTML](gilmore-lab.github.io/2018-10-15-nyu/PLAY-LEGO-report.html)
<!-- Download Datavyu spreadsheet and manipulate it. -->

## The future of reproducible workflows
...
<img src="https://bookdown.org/yihui/rmarkdown/images/cover.png" height=300px/>
...
<https://onlinelibrary.wiley.com/page/journal/15327078/homepage/ForAuthors.html>
