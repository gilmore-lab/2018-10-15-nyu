...
$States_{internal} + States_{external} = \Psi_{better}$
...
> That's a bad thing! It means you have an incentive to be lazy and to avoid redoing your stuff. And you waste tons of time when you do. 
...
- Separate data (needing protection) from analysis code
- R Markdown documents (and Jupyter notebooks) as self-documenting records
...
# Psychological science (esp. developmental) can be a leader in the development of **r**obust and **r**eproducible **r**esearch practices
